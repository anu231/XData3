...
public class GetTupleAssignmentUsingSolver {
	...
	public boolean getTupleAssignment() throws Exception{
		...
		System.out.println("Constraint Generation Time: " + (endAssgn-startAssgn) );
	...
	private boolean solveConstraints(String constraints) throws Exception{
		...
		cmdString += "cvc3 "+ Configuration.homeDir+"/temp_cvc"+ getFilePath() +"/tupleAssignment.cvc > tupleAssignmentOutput \n";

		/**command to check if solution is valid/ not i.e. possible or not*/
		//cmdString += "cvc3 "+ Configuration.homeDir+"/temp_cvc"+ getFilePath() +"/tupleAssignment.cvc | grep -e 'Valid' > isValid \n";
		...
		System.out.println("Constraint Solving Time: " + (endT-startT) );
	...
	public static void main(String[] args) throws Exception{
		...
		GetTupleAssignmentUsingSolver gtas = new GetTupleAssignmentUsingSolver( new GetTupleAssignment(null), "4");
