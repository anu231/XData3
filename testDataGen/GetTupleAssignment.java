...
public class GetTupleAssignment {
	 ...
	 * Constructor
	 */
	public GetTupleAssignment(String defaultRootNode){
	...
	public boolean getTupleAssignmentForQuery() throws Exception{
		...
		System.out.println("");
		System.out.println("ENTER TUPLE ASIGNMENT METHOD :");
		System.out.println("");
		...
		System.out.println("-------------------------------------------------");
		System.out.println("start Attr: "+startAttribute);
		System.out.println("end Attr: "+endAttribute);
		System.out.println("start Assgn: "+startAssgn);
		System.out.println("end assgn: "+endAssgn);
		System.out.println("Attribute Inference Time: " + (endAttribute-startAttribute) );
		System.out.println("Tuple  Assignment Time: " + (endAssgn-startAssgn) );
		System.out.println("-------------------------------------------------");
		...
		if(possible == false){
			System.out.println("-------------------------------------------------");
			System.out.println("CALLING TUPLE ASSIGNMENT USING CONSTRAINT SOLVER");
			System.out.println("-------------------------------------------------");
			...
			System.out.println("-------------------------------------------------");
			System.out.println("END OF CALLING TUPLE ASSIGNMENT USING CONSTRAINT SOLVER");
			System.out.println("-------------------------------------------------");

			return possible;
		}
		System.out.println("");
		System.out.println("EXIT TUPLE ASSIGNMENT METHOD");
		System.out.println("");
	...
	public Graph<JoinGraphNode, JoinAndUniqueAttributes> constructJoinGraph()  throws Exception{
		...
		System.out.println("Construction the join graph for " + joinConds);
		...
		System.out.println("Join graph constructed");
		return joinGraph;
	}
	...
	public void getAttributeInferences() throws Exception{
		...
		System.out.println("Inferring the properties of attributes of in the join conditions ");
		...
		do{
			...
			System.out.println("At the start of loop SV attributes size:  " + sSize + " unique elements size: "+ uSize);
			...
			System.out.println("Rule 6 for " + uniqueElements);
			...
			for(HashSet< Node > u: uniqueElements){
				...
				if( uDup.size() != 0 && (!(uDup.equals(u))) ){
					...
					System.out.println("-----------------------");
					System.out.println("Rule 6 is true : " + u);
					System.out.println("New set : " + uDup);
					System.out.println("-----------------------");
			...
			System.out.println("Rule 6 changed elements: " + flag);
		...
		for(Node sv: singleValuedAttributes)
			singleValuedAttributesDup.add( (Node)sv.clone() );
	}
	...
	public JoinGraphNode chooseRootNode()  throws Exception{
		System.out.println("Choosing the relation whose cardinality can be (acts as starting point for the join graph): " + finalCount);
		...
		System.out.println("");
		System.out.println("The node chosen with cardinality = 'finalCount' is : " + jgn);
		System.out.println("");
	...
	public void segregateUniqueElements()  throws Exception{
		...
		System.out.println("Finding the join attributes which form unique element");
		System.out.println("");
		...
		System.out.println("");
		System.out.println("The join attributes which form unique element are found");
	}
	...
	public void segregateUniqueElementsOfNode(Set<Node> unique, JoinGraphNode jgn)  throws Exception{
		System.out.println("");
		System.out.print("Finding the join attributes which form unique element for the edge from " + jgn);
		...
		while (itr.hasNext()) {
			...
			System.out.print(" to " + (JoinGraphNode)pairs.getKey());
			System.out.println("");
			...
			System.out.println("Completed for this edge ");
			System.out.println("");
		}
	}
	...
	public boolean getActualCardinality(JoinGraphNode root)  throws Exception{
		...
		System.out.println("");
		System.out.println("Getting the cardinality");
		...
		while(it.hasNext()) {
			...
			System.out.println(" The new node chosen from nList is: " + jgn);
			...
			while (itr.hasNext()) {
				...
				if(size != uniqueElements.size() || flag == true){
					System.out.println("Adding to nList "+ (JoinGraphNode)pairs.getKey());

					nList.add((JoinGraphNode)pairs.getKey());

					System.out.println("nList now is: " + nList);
				}
			}
			...
			if(jgn1 != null && !jgn1.isEmpty()){
				...
				System.out.println("Adding to nList by rule 8: " + jgn1);
				nList.addAll(jgn1);
			...
			if(!flag1) {
				nList.remove(jgn);
				System.out.println("nList after removing "+ jgn +" is: " + nList);
			}
	...
	public void applyRule7(Map.Entry pairs) throws Exception {
		...
		System.out.print(" to the node " + (JoinGraphNode)pairs.getKey() + "\n");
	...
	private Set<JoinGraphNode> applyRule8(JoinGraphNode jgn) throws Exception{
		...
		System.out.println("");
		System.out.println("APPLYING RULE 8 for the node " + jgn);
		System.out.println("");
		...
		System.out.println("Multi attribute unique elements of node " + jgn +" are " + unique);
		...
		while(it.hasNext()){
			...
			while (itr.hasNext() && flag == false) {//for each edge and iff rule 8 is not applied
				...
				System.out.println("Traversing the edge from "+ jgn + " to " + (JoinGraphNode)pairs.getKey());
	...
	public HashSet<HashSet< Node >> updateUniqueElements(Entry pairs) throws Exception{
		...
		System.out.println("Updating unique elements for the node " + (JoinGraphNode)pairs.getKey());
		...
		System.out.println("");
		System.out.println("New set of unique elements are " + newUnique);
		...
		System.out.println("Unique Elements are updated for the node "+ (JoinGraphNode)pairs.getKey());
		return newUnique;
	}
	...
	public boolean modifyUniqueElements() throws Exception{
		...
		System.out.println("Keeping minimum set of unique elements by removing super sets in " + uniqueElements);
		...
		System.out.println("New set of unique elements " + uniqueElements);
		System.out.println("");
		return change;
	}
